...
const InvoicesPage = (props) => {
    ...
    // Gestion de la recherche de customers
    ...
    const paginatedInvoicess = Pagination.getData(
        filteredInvoices,
        currentPage,
        itemsPerPage)
        ...
        <table className="table table-hover">
            <thead>
                <tr>
                    ...
                    <th className="text-center">Satut</th>
                    <th className="text-center">Montant</th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                {paginatedInvoicess.map(invoice => <tr key={invoice.id}>

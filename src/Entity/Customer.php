 ...
 * },
 *  normalizationContext={"groups"={"customers_read", "invoices_read"}}
 * )
...
class Customer
{
     ...
     * @Groups({"customers_read", "invoicesRead"})
     */
    private $id;
    ...
    /**
     * Permet de récupérer le total des factures par client
     * @Groups({"customers_read"})
     * @return float
     */
    ...
    /**
     * Récupérer le montont total non payé (hors factures payées ou annulées)
     * @Groups({"customers_read"})
     * @return float
     */
